                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">Bill Update</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card card-primary">
                        ...
                        <div class="card-body">
                            <form action="<%=request.getContextPath()%>/billDetai/update" method="post">
                                    <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="billId">BillId</label>
                                        <input type="text" readonly id="billId" name="bill.billId" value="${editBill.bill.billId}" class="form-control">
                                    </div>
                                    <div class="form-group">
                                        <label for="billDetailId">BillDetailId</label>
                                        <input type="text" readonly id="billDetailId" name="billDetailId" value="${editBill.billDetailId}" class="form-control">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="productId">ProductId</label>
                                        <input type="text" readonly id="productId" name="product.productId" value="${editBill.product.productId}" class="form-control">
                                    </div>
                                    <div class="form-group">
                                        <label for="importPrice">Price</label>
                                        <input type="text" id="importPrice" name="importPrice" value="${editBill.importPrice}" class="form-control">
                                    </div>
                                    <div class="form-group">
                                        <label for="quantity">Quantity</label>
                                        <input type="text" id="quantity" name="quantity" value="${editBill.quantity}" class="form-control">
                                    </div>
                                </div>
                                    </div>
                                <div class="col-12">
                                    <a href="<%=request.getContextPath()%>/bill/findBill" class="btn btn-secondary">Cancel</a>
