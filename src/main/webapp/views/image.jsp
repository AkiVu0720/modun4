                                ...
                                <form>
                                    <div class="row">
                                        <div class="col-md-10 offset-md-1">
                                            <div class="row">
                                                <div class="col-12">
                                                    <form action="<%=request.getContextPath()%>/image/findImage" method="get">
                                                    ...
                                                    <form>
                                                        <div class="form-group">
                                                            ...
                                                            <select id="sortBy" name="sortBy" class="select2" style="width: 100%;">
                                                                <option value="imageId" ${sortBy.equals("imageId")?'selected':''}>Id</option>
                                                            </select>
                                                        </div>
                                                    </form>
                                                </div>
                                ...
                                <table id="example2" class="table table-bordered table-hover">
                                    ...
                                    <tr>
                                        ...
                                        <td class="project-actions text-right">
                                            <a class="btn btn-info btn-sm" href="<%=request.getContextPath()%>/image/initUpdate?imageId=${image.imageId}">
                                                <i class="fas fa-pencil-alt">
                                                </i>
                                                Edit
                                            </a>
                                            <a class="btn btn-danger btn-sm" href="<%=request.getContextPath()%>/image/delete?imageId=${image.imageId}">
