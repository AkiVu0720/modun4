        ...
        <div class="sidebar">
            ...
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item">
                        <a href="<%=request.getContextPath()%>/bill/findBill" class="nav-link active">
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">List data Bill</h3>
                            </div>
                            <!-- /.card-header -->
                                ...
                                <form>
                                    <div class="row">
                                        <div class="col-md-10 offset-md-1">
                                            <div class="row">
                                                <div class="col-12">
                                                    <form action="<%=request.getContextPath()%>/bill/findBill" method="get">
                                                        <div class="form-group">
                                                            <div class="input-group input-group-lg pt-2">
                                                                <input type="search" id="billId" name="billId" class="form-control form-control-lg" placeholder="search BillId">
                                                                <div class="input-group-append">
                            ...
                            <div class="card-body p-0">
                                ...
                                <c:forEach items="${listBillDetail}" var="bilDetail">
                                ...
                                <table class="table table-hover">
                                    ...
                                    <tr data-widget="expandable-table" aria-expanded="true">
                                        <th>
                                            ...
                                            BillId: ${bilDetail.bill.billId} - UserName: ${bilDetail.bill.account.userName}  - ${bilDetail.bill.billStatus==1?"Đang chờ":bilDetail.bill.billStatus==2?"Đã Duyệt": bilDetail.bill.billStatus==3?"Đang Giao":"Đã nhận"}
                                        </th>
                                                        ...
                                                        <tr data-widget="expandable-table" aria-expanded="false">
                                                            <td>
                                                                <table id="example2" class="table table-bordered table-hover">
                                                                    ...
                                                                    <tbody>
                                                                    <c:forEach items="${listBillDetail}" var="billDetail2">
                                                                    <tr>
                                                                        ...
                                                                        <td class="project-actions text-right">
                                                                            <a class="btn btn-info btn-sm" href="<%=request.getContextPath()%>/bill/initUpdate?billDetailId=${billDetail2.billDetailId}">
                                                                                <i class="fas fa-pencil-alt">
                                                                                </i>
                                                                                Edit
                                                                            </a>
                                                                            <a class="btn btn-danger btn-sm" href="<%=request.getContextPath()%>/bill/delete?billDetailId=${billDetail2.billDetailId}">
