                                ...
                                <form>
                                    <div class="row">
                                        <div class="col-md-10 offset-md-1">
                                            <div class="row">
                                                <div class="col-12">
                                                    <form action="<%=request.getContextPath()%>/userManage/findUser" method="get">
                                                        <div class="form-group">
                                                            <div class="input-group input-group-lg pt-2">
                                                                <input type="search" id="email" name="email" class="form-control form-control-lg" placeholder="search email">
                                                                <div class="input-group-append">
                                                    ...
                                                    <form>
                                                        <div class="form-group">
                                                            ...
                                                            <select id="sortBy" name="sortBy" class="select2" style="width: 100%;">
                                                                <option value="accId" ${sortBy.equals("accId")?'selected':''}>Id</option>
                                                                <option value="userName" ${sortBy.equals("userName")?'selected':''}>Name</option>
                                                                <option value="created" ${sortBy.equals("created")?'selected':''}>Day</option>
                                                                <option value="role" ${sortBy.equals()?'selected':''}>Role</option>
                                                            </select>
                                                        </div>
                                                    </form>
                                                </div>
...
<script type="text/javascript">
    $(".page-category").click(function () {
        ...
        $.ajax({
            type: "GET",
            url: "http://localhost:8080/user/findUser?page="+pageId,
            // data: { name: "John", location: "Boston" }
        }).done(function() {
            window.location = "http://localhost:8080/user/findUser?page="+pageId
        });
    })
</script>
