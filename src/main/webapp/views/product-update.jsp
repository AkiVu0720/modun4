                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="productId" readonly name="productId" class="form-control" value="${productEdit.productId}">
                                            </div>
                                            <div class="form-group">
                                                <label for="category">Category Name</label>
                                                <select id="category" name="category.categoryId" class="form-control custom-select">
                                                    <c:forEach items="${categoryList}" var="category">
                                                    <option value="${category.categoryId}" ${productEdit.category.categoryId.equals(category.categoryId)?"selected":""}>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="productName" name="productName" class="form-control" value="${productEdit.productName}">
                                            </div>
                                            <div class="form-group">
                                                <label for="price">Price</label>
                                                <input type="text" id="price" name="price" class="form-control" value="${productEdit.price}">
                                            </div>
                                            <div class="form-group">
                                                <label for="productUnit">Unit</label>
                                                <input type="text" id="productUnit" name="productUnit" class="form-control" placeholder="g,Kg" value="${productEdit.productUnit}">
                                            </div>
                                            <div class="form-group">
                                                <label for="productStatus">Status</label>
                                                <select id="productStatus" name="productStatus" class="form-control custom-select">
                                                    <option disabled>Select one</option>
                                                    <option value="true" ${productEdit.productStatus?"selected":""}>Active</option>
                                                    <option value="false" ${productEdit.productStatus?"":"selected"}>Inactive</option>
                                                </select>
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="tittle" name="tittle" class="form-control" value="${productEdit.tittle}">
                                            </div>
                                            <div class="form-group">
                                                <label>Date</label>
                                                <div class="input-group " >
                                                    ...
                                                    <input type="date"
                                                           ...
                                                           name="productCreated"
                                                           class="form-control"
                                                           value="${productEdit.productCreated}"
                                                           readonly
                                                    >
                                                </div>
                                            ...
                                            <div class="form-group">
                                                <label for="productImageEdit">Image Info</label>
                                                <div class="input-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea id="description" name="description" class="form-control" rows="6">${productEdit.description}</textarea>
                                            </div>
                                        </div>
                                        <div class="col-12">
...
<!-- Select2 -->
<script src="../resources/init/plugins/select2/js/select2.full.min.js"></script>
<!-- InputMask -->
<script src="../resources/init/plugins/moment/moment.min.js"></script>
<script src="../resources/init/plugins/inputmask/jquery.inputmask.min.js"></script>
<!-- Tempusdominus Bootstrap 4 -->
<script src="../resources/init/plugins/tempusdominus-bootstrap-4/js/tempusdominus-bootstrap-4.min.js"></script>
<!-- Bootstrap Switch -->
<script src="../resources/init/dist/js/adminlte.min.js"></script>
